...
## My treasure trove of observations 
...
Resolve all issues concerning ownership and use with rights holders. 
...
:::: r-stack
::: {.fragment .fade-out}
### Identify yourself, e.g. {{< fa brands orcid >}}
...
- https://www.wikidata.org/wiki/Q734764
:::
::: {.fragment .fade-in-then-out}
### Identify your data
...
I uploaded my `Rdata` file [here](https://figshare.com/articles/dataset/IUCN_Red_List_of_Ecosystem_assessment_results_for_IVC_Forest_Macrogroups_in_the_Americas_region/7488872)
...
Great for github integration: transform your repository into a release with DOI.

[![](https://zenodo.org/badge/DOI/10.5281/zenodo.5234108.svg)](https://doi.org/10.5281/zenodo.5234108)
...
See [this example](https://doi.org/10.5061/dryad.k3j9kd58b)
:::
...
<div>
![UNSW codeRs logo](https://unsw-coders.netlify.app/images/logo_hu20be6c44ea68e676024b4aa4f3296560_161224_0x70_resize_lanczos_2.png){height=50} <span style="vertical-align: top;">[UNSW codeRs](https://unsw-coders.netlify.app/)</span>
</div>
